...
const PRIMARY_COLOR = "#068980";
const SELECT_COLOR = "#FFFFCC";
const SEPERATOR_COLOR = "#EE7525";
const SECONDARY_COLOR = "#FFFFFF";
const TEXT_COLOR = "#068980";
	...
	onRowPress(sectionID, rowID) {
		...
		this.setState({
			dataSource:
				...
				this.state.dataSource.cloneWithRows(this.preparedRows)
		});
	}
	...
	_renderLog(item) {
		return (
			...
			>
				...
				<Text style={styles.logRowMessage}>
					{item.item.timeStamp.format("HH:mm:ss")}
				</Text>
			</TouchableOpacity>
		);
	}
			...
			<View style={styles.container}>
				<View style={styles.toolBar}>
					...
					>
						...
						>{`${this.state.rows.length} rows`}</Text>
					</TouchableOpacity>
					<TouchableOpacity
						style={styles.toolbarButton}
